...
func (x *PBMatchReq) GetUid() string {
	if x != nil {
		return x.Uid
	}
	return ""
...
var file_protocol_proto_rawDesc = []byte{
	...
	0x22, 0x1e, 0x0a, 0x0a, 0x50, 0x42, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x71, 0x12, 0x10,
	0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x69, 0x64,
	0x2a, 0x20, 0x0a, 0x05, 0x4d, 0x73, 0x67, 0x49, 0x44, 0x12, 0x0b, 0x0a, 0x07, 0x49, 0x4e, 0x56,
	0x41, 0x4c, 0x49, 0x44, 0x10, 0x00, 0x12, 0x0a, 0x0a, 0x05, 0x4c, 0x4f, 0x47, 0x49, 0x4e, 0x10,
	0xe8, 0x07, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x3b, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_protocol_proto_goTypes = []interface{}{
	(MsgID)(0),         // 0: pb.MsgID
	(*Head)(nil),       // 1: pb.Head
	(*PBLoginReq)(nil), // 2: pb.PBLoginReq
	(*PBMatchReq)(nil), // 3: pb.PBMatchReq
}
